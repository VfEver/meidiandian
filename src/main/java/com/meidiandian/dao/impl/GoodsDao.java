...
public class GoodsDao implements IGoodsDao {
	...
	public List<Goods> findGoodsByStoreID(int storeID) {
		...
		List<Goods> goodsList = sqlSession.selectList(Goods.class.getName() + ".findGoodsByStoreID", storeID);
		sqlSession.close();
		return goodsList;
	}
	...
	public Goods findGoodsByID(int id) {
		...
		SqlSession sqlSession = sqlSessionFactory.openSession();
		Goods goods = sqlSession.selectOne(Goods.class.getName() + ".findGoodsByID", id);
		sqlSession.close();
		return goods;
	}
