...
public class StoreDao implements IStoreDao {
	...
	public Store selectStoreByUserID(int id) {
		...
		Store store = sqlSession.selectOne(Store.class.getName()
				+ ".selectStoreByUserID", id);
		sqlSession.close();
	...
	public List<Store> findStoreByCity(String city) {
		...
		SqlSession sqlSession = sqlSessionFactory.openSession();
		List<Store> storeList = sqlSession.selectList(Store.class.getName()
				+ ".findStoreByCity", city);
		sqlSession.close();
		return storeList;
	}
